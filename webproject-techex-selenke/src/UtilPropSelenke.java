...
public class UtilPropSelenke {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Natie\\Desktop\\Intro to software\\Workspace4830\\workspace4830-techex-selenke\\webproject-techex-selenke\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject-techex-selenke/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject-techex-selenke/config.properties";
